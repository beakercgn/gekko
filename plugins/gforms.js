...
gforms.prototype.processTrade = function(trade) {
  ...
  //let stratName = config.tradingAdvisor.method;
  let stratName = config.name.name;

  //build up string
  let dmethodName = dataString =
    ...
    'entry.' + gfc.stratName + '=' + stratName;

  //log.info('CONFIG9:::::' + dataString);
  //console.log("#######################################")
